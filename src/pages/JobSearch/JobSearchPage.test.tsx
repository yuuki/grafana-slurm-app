...
import { saveLinkedDashboardSelection } from '../../storage/userPreferences';
import { navigateToLinkedDashboard } from './linkedDashboard';
...
jest.mock('./linkedDashboard', () => ({
  ...jest.requireActual('./linkedDashboard'),
